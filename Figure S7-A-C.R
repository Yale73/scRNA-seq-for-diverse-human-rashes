...
colnames(RashX1)
colnames(RashX1) <- c("LP1", "LP2", "BP", "ADvsPV")
...
write.xlsx(RashX1, "F:/4-7-20m-Final-1030/Figure S4/Figure S7 double check/ADvsPV_matrix_Final.xlsx", rowNames=T, colNames=T)
#Pso-specific genes heatmap
colnames(RashX2) <- c("LP1", "LP2", "BP", "PVvsAD")
...
write.xlsx(RashX2, "F:/4-7-20m-Final-1030/Figure S4/Figure S7 double check/PVvsAD_matrix_Final.xlsx", rowNames=T, colNames=T)
...
our <- RenameIdents(our, `150` = "NML1", `154` = "NML2", `155` = "NML3",`169` = "NML4",`195` = "NML5", `204` = "NML6", 
                    ...
                    `222` = "PV6", `234` = "PV7", `235` = "PV8",  `167` = "F", `174` = "A", `192` = "C", `200` = "E",
                    `202` = "D", `219` = "B", `141` = "LP1", `163` = "LP2", `175` = "BP")
...
colData(human_human_big_cds)$dis_updated = gsub("141","LP and BP",colData(human_human_big_cds)$dis_updated)
colData(human_human_big_cds)$dis_updated = gsub("163","LP and BP",colData(human_human_big_cds)$dis_updated)
colData(human_human_big_cds)$dis_updated = gsub("175","LP and BP",colData(human_human_big_cds)$dis_updated)
...
re_int
write.xlsx(re_int, "F:/4-7-20m-Final-1030/Figure S4/Figure S7 double check/hyperdimensioanl_matrix_Final.xlsx", rowNames=T, colNames=T)
...
ind_samps = subset(re_int, dis=="LP and BP")$status
...
write.xlsx(statistic, "F:/4-7-20m-Final-1030/Figure S4/Figure S7 double check/statistic_matrix_Final.xlsx", rowNames=T, colNames=T) 
